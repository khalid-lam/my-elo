                    ...
                    $.getJSON(url + '/tennis_leaderboard.php', function (tennisUsersList) {
                        ...
                        tennisUsersList.forEach((user, index) => {
                            if (index === 0) {
                                ...
                                user.rank = '<i class="fas fa-medal" style="color: silver;"></i>'; // Silver medal for 2nd place
                            } else if (index === 2) {
                                user.rank = '<i class="fas fa-medal" style="color: #cd7f32;"></i>'; // Bronze medal for 3rd place
                            } else {
